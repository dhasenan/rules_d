...
def d_repositories(version='2.070.0'):
  native.new_http_archive(
      name = "dmd_linux_x86_64",
      urls = [
          "http://downloads.dlang.org/releases/2.x/{0}/dmd.{0}.linux.tar.xz".format(version),
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://downloads.dlang.org/releases/2.x/{0}/dmd.{0}.osx.tar.xz".format(version),
      ],
      build_file_content = DMD_BUILD_FILE,
  )
